...
#define RUNTIME_IO_LIN_ADC_PID         0x24U
#define RUNTIME_IO_LIN_OK_PID          0x25U
#define RUNTIME_IO_LIN_OK_TOKEN        0xA5U
#define RUNTIME_IO_LIN_TIMEOUT_TICKS   100U
...
InfraStatus RuntimeIo_GetMasterLinConfig(LinConfig *out_config)
{
    ...
    out_config->pid_status = RUNTIME_IO_LIN_ADC_PID;
    out_config->pid_ok = RUNTIME_IO_LIN_OK_PID;
    out_config->ok_token = RUNTIME_IO_LIN_OK_TOKEN;
    out_config->status_frame_size = 8U;
    out_config->ok_frame_size = 1U;
    out_config->timeout_ticks = RUNTIME_IO_LIN_TIMEOUT_TICKS;
    ...
    LinHw_Configure(LIN_HW_ROLE_MASTER, RUNTIME_IO_LIN_TIMEOUT_TICKS);
